...
/*   Updated: 2019/09/18 19:06:33 by qmebble          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						find_solution(t_sum s, t_moove	**moove,\
						t_queue **queue);
...
int						if_in_q(int step, int parent,\
...
int						ft_solut_return(int status, t_queue *queue,\
						t_moove *moove, char *tab);
